...
5. [Magento2 Admin Ui component Edit button](8.3.admin-ui-edit-form-Buttons.md)
...
```
- `{EDIT_ACL_RESOURCE_ID}` is defined at 6.Admin-url-using-route-acl.md#aclxml
...
- `{Delete_ACL_RESOURCE_ID}` is defined at 6.Admin-url-using-route-acl.md#aclxml
- `{Paramster_For_Delete_FORM}` see  parameter at 8.3.admin-ui-edit-form-Buttons.md#8-add-delete-button-to-edit-ui-form
...
class Delete  extends  \Magento\Backend\App\Action
{
     ...
     */
     ...
     const ADMIN_RESOURCE ="Codelegacy_Genesis::example_delete";
...
See module-row/app/code/Codelegacy/Genesis/Controller/Adminhtml/Genesis/NewAction.php
...
see 8.1.admin-grid-using-ui.md
