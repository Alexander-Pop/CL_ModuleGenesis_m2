...
## 3.ActionFileName.php
 Need to update file from 6.Admin-url-using-route-acl.md#actionfilenamephp
...
namespace {Vendor}\{ModuleName}\Controller\Adminhtml\Genesis;
...
- `{menUI}` is Menu if which is defined at [app/code/{Vendor}/{ModuleName}/etc/adminhtml/menu.xml](7.admin-menu-Admin-page.md#menuxml).
...
- `{Database_Table_Primary_key_Name}` This Primary key Field of that table which is defined at Resource Model Class 5.build-model.md#create-resource-model-class
...
<listing xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
    ...
    <columns name="example_ui_listing_columns">
        ...
        -->
        <actionsColumn name="actions" 
                       class="Codelegacy\Genesis\Ui\Listing\Columns\GenesisActions">
            <settings>
                <!-- IndexField is same as selectionsColumn indexField -->
...
- `{Ui_ComponentName_Listing_name}_data_source}` see at  datasource name from 8.admin-grid-using-ui.md#ui_componentname_listing_name-file
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
    ...
    <!-- Defined Collection Class for Grid of Ui component listing -->
    <!-- name is virtual Type --> 
       <virtualType name="Codelegacy\Genesis\Model\ResourceModel\Student\Grid\Collection" 
                    type="Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult">
        <arguments>
            <argument name="mainTable" xsi:type="string">example</argument>
            <argument name="resourceModel" xsi:type="string">Codelegacy\Genesis\Model\ResourceModel\Student</argument>
        </arguments>
    </virtualType>
    <!-- Add Virtual Grid Class to  Ui compoment -->.
    <type name="Magento\Framework\View\Element\UiComponent\DataProvider\CollectionFactory">
        <arguments>
            <argument name="collections" xsi:type="array">
                <!--name format is UiComponent file name__data_source -->
                <item name="example_ui_listing_data_source" xsi:type="string">Codelegacy\Genesis\Model\ResourceModel\Student\Grid\Collection</item>
            </argument>
        </arguments>
    </type>
